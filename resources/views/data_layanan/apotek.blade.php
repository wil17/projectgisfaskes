...
<head>
    ...
    <title>Data Apotek di Kota Banjarmasin</title>
...
<div class="container mt-5 mb-5 fade-in">
    ...
    <div class="row mb-4 align-items-center">
        <div class="col-md-6 col-sm-12">
            <h1 class="mb-2">Data Apotek di Kota Banjarmasin</h1>
            <p class="lead text-muted">Informasi lengkap tentang apotek yang ada di Kota Banjarmasin</p>
        </div>
        <div class="col-md-6 col-sm-12 d-flex align-items-center justify-content-md-end gap-2 mt-3 mt-md-0">
            <!-- Lihat di Peta Button -->
            <a href="{{ route('map') }}?focus=apotek" class="btn btn-outline-primary">
    ...
    <div class="card shadow mb-4">
        <div class="card-header bg-white">
            <div class="row align-items-center">
                <div class="col-md-6">
                    <h5 class="mb-0"><i class="fas fa-search me-2 text-primary"></i>Cari Apotek</h5>
                </div>
                <div class="col-md-6 text-md-end mt-2 mt-md-0">
                    <span class="badge bg-primary rounded-pill">
                        <i class="fas fa-pills me-1"></i>Total: {{ $apotek->total() }} Apotek
                    </span>
                </div>
            </div>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-md-8 mb-3 mb-md-0">
                    <form action="{{ route('data.layanan.apotek') }}" method="GET" id="searchForm">
                ...
                <div class="col-md-4">
                    <form action="{{ route('data.layanan.apotek') }}" method="GET" id="kecamatanForm">
                        <div class="input-group">
                            <span class="input-group-text bg-transparent border-end-0">
            ...
            <table class="table table-hover mb-0 responsive-card-table">
                <thead>
                    <tr>
                        ...
                        <th>Alamat</th>
                        <th>
                            <a href="{{ route('data.layanan.apotek', ['sort' => 'kecamatan', 'direction' => request('sort') == 'kecamatan' && request('direction') == 'asc' ? 'desc' : 'asc', 'search' => request('search'), 'kecamatan' => request('kecamatan')]) }}" 
                               class="text-decoration-none text-dark d-flex align-items-center">
                                Kecamatan
                        ...
                        <tr>
                            <td colspan="6" class="text-center py-4">
                                <div class="py-3">
                                    ...
                                    <h5>Tidak ada data apotek yang ditemukan</h5>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="detailModalLabel">Detail Apotek</h5>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="detail-row">
                            <div class="detail-label">Nama Apotek</div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        detailButtons.forEach(button => {
            button.addEventListener('click', function() {
                ...
                // Set link to map
                document.getElementById('lihatPeta').href = `{{ route('map') }}?focus=apotek&id=${id}`;
