...
@section('page-title', 'Tambah Klinik')
            ...
            <div class="col-lg-10">
                <div class="form-card">
                    <div class="form-header">
                        <h1><i class="fas fa-stethoscope"></i> Tambah Klinik Baru</h1>
                        <p class="subtitle">Isi informasi klinik dengan lengkap dan akurat</p>
                    </div>
                    ...
                    <div class="form-body">
                        ...
                        <form action="{{ route('admin.klinik.store') }}" method="POST" id="createKlinikForm">
                            @csrf
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="nama_klinik" name="nama_klinik" 
                                               value="{{ old('nama_klinik') }}" required placeholder="Masukkan nama klinik">
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="alamat" name="alamat" rows="3" required placeholder="Masukkan alamat lengkap klinik">{{ old('alamat') }}</textarea>
                            </div>
                            ...
                            <div class="btn-group">
                                ...
                                <button type="submit" class="btn btn-primary">
                                    <i class="fas fa-save"></i> Simpan Klinik
                                </button>
                            </div>
                        </form>
                    </div>
...
<script>
    ...
    function getKelurahans(kecamatan) {
        $.ajax({
            url: '{{ route("admin.get-klinik-kelurahans") }}',
            type: 'GET',
    ...
    function getLocationCoordinates(kecamatan, kelurahan) {
        $.ajax({
            url: '{{ route("admin.get-klinik-location-coordinates") }}',
            type: 'GET',
            data: { 
                kecamatan: kecamatan,
                kelurahan: kelurahan
