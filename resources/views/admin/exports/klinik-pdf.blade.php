<!-- resources/views/admin/exports/klinik-pdf.blade.php -->
<!DOCTYPE html>
<html lang="id">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Data Klinik - {{ $kecamatan }}</title>
    <style>
        body {
...
<body>
    <div class="header">
        ...
        <div class="title">Data Klinik di Kota Banjarmasin</div>
    ...
    <table>
        ...
        <tbody>
            @foreach($kliniksList as $index => $item)
            <tr>
                <td class="text-center">{{ $index + 1 }}</td>
                <td>{{ $item->nama_klinik ?? 'Klinik ' . $item->id_klinik }}</td>
    ...
    <div class="footer">
        ...
        <p class="metadata">ID: PDF-KLN-{{ date('YmdHis') }}</p>
    </div>
</body>
</html>